  ...
  <nav class="py-2 fixed-top">
    <div class="container d-flex flex-wrap">
      <ul class="nav me-auto">
        <li class="nav-item"><router-link to="/" class="nav-link px-2 active" aria-current="page">Домашняя страница</router-link></li>
        <li class="nav-item"><a href="#" class="nav-link px-2">Ссылки</a></li>
        <li class="nav-item"><a href="#" class="nav-link px-2">Цены</a></li>
        <li class="nav-item"><a href="#" class="nav-link px-2">Вопросы</a></li>
      ...
      <div class="flex-shrink-0 dropdown">
        <a href="#" class="d-block text-decoration-none" id="dropdownUser2" data-bs-toggle="dropdown" aria-expanded="false" style="margin-top:5px">
          <img src="/images-cloud/user_account_profile_icon.svg" alt="Профиль" width="24" height="24" class="rounded-circle">
        </a>
      ...
      <div class="shopping-cart">
        <router-link to="/cart/" class="d-block text-decoration-none" id="dropdownUser2" aria-expanded="false" style="margin-top:4px">
          <img src="/images-cloud/basket_icon.svg" alt="Корзина" width="28" class="rounded-circle">
